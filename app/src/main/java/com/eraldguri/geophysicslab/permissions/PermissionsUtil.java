...
public class PermissionsUtil {
    ...
    public PermissionsUtil(Activity context, String... requiredPermissions) {
        mContext = context;
     ...
     * {@link PermissionsUtil#areAllRequiredPermissionsGranted(String[], int[])} to check that all the
